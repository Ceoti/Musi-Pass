...
# 헤더
st.markdown("<div class='header'><h2>뮤지컬 《베르사유의 장미》</h2></div>", unsafe_allow_html=True)
...
with container:
    ...
    # csv data
    review = pd.read_csv('versailles_review_emp.csv', encoding='cp949')
    # 왼쪽 사이드바
    with col1:
        st.image("http://www.kopis.or.kr/upload/pfmPoster/PF_PF242052_240530_132555.gif")
        casting = pd.read_csv("베르사유_캐스팅.csv", encoding="cp949")
    ...
    with col2:
        ...
        blog = load_workbook("베르사유의_장미_블로그_크롤링.xlsx")
    ...
    # 오른쪽 사이드바
    with col3:
        url = "https://tickets.interpark.com/goods/24007345"
        options = Options()
